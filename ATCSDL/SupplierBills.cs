...
namespace ATCSDL
{
    public partial class SupplierBills : Form
    {
        ...
        public SupplierBills(string loginSupplier)
        {
            InitializeComponent();
        ...
        public List<Order> GetOrderFromSql(string StatusOrder)
        {
            ...
            if (StatusOrder.Equals(""))
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string query = "SELECT * FROM [Order] WHERE LoginSupplier = @LoginSupplier";
            ...
            else
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    // Truy vấn dữ liệu từ bảng Order
                    string query = "SELECT * FROM [Order] WHERE LoginSupplier = @LoginSupplier AND StatusOrder = @StatusOrder";
                    using (SqlCommand command = new SqlCommand(query, connection))
                    {
                        // Thêm tham số cho truy vấn để tránh tấn công SQL Injection
                        command.Parameters.AddWithValue("@LoginSupplier", loginSupplier);
        ...
        private void Panel_Click(object sender, EventArgs e)
        {
            ...
            string query = "SELECT StatusOrder, LoginCustomer FROM [Order] WHERE IDOrder = @IDOrder";
        ...
        private void PictureBox_Click(object sender, EventArgs e)
        {
            ...
            InfoSupplierBill infoBill = new InfoSupplierBill(productInOrder, loginSupplier, loginCustomer, statusOrder, productInOrder[0].IDOrder);
            infoBill.Show();
            this.Close();
        }
