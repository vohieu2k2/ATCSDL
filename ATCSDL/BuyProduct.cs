...
namespace ATCSDL
{
    public partial class BuyProduct : Form
    {
        ...
        private void BuyProduct_Load(object sender, EventArgs e)
        {
            ...
            string query = "SELECT NameCategory FROM [Category] WHERE IDCategory = @IDCategory";
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                command.Parameters.AddWithValue("@IDCategory", product.category);
                ...
                using (SqlDataReader reader = command.ExecuteReader())
                {
                    if (reader.Read())
                    {
                        ...
                        categoryLabel.Text = reader.GetString(reader.GetOrdinal("NameCategory"));
                    }
                }
            }
            ...
            pictureBox.SizeMode = PictureBoxSizeMode.Zoom; // Hiển thị ảnh theo tỉ lệ
